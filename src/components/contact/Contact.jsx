          ...
          <div className="row py-lg-5">
            <div className="col-lg-6 col-md-8 mx-auto text-center">
              ...
              <p className="lead text-body-secondary">
                Have any questions or comments? Feel free to get in touch with
                us.{" "}
              </p>
            </div>
                      ...
                      <div className="d-flex mb-5"> 
                        ...
                        <div>
                          ...
                          <a
                            ...
                            href="https://maps.app.goo.gl/yxz2Rh2gyNTKJKfi7"
                          >
                            Mabacong , Batangas City, Philippines
                          </a>
                        </div>
                      </div>
                      <div className="d-flex mb-5">
                      ...
                      <div className="d-flex">
                        ...
                        <div>
                          ...
                          <div className="d-flex mb-1">
                            ...
                            <p className="text-secondary mb-0">7am - 5pm</p>
                          </div>
                          <div className="d-flex">
                            <p className="text-secondary fw-bold mb-0 me-5">
                              Sat - Sun
